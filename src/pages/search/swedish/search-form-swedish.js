...
function SearchFormSwedish() {
    ...
    function search() {
        ...
        */
        ...
        .catch(() => {
            dispatch(pageActions.setErrorMessage('Ett serverfel har uppstått.' + 
                'Din sökning kunde inte genomföras. Försök igen lite senare.'));
        });
    }
    ...
    return (
        <form role="search" onSubmit={(e) => handleSubmit(e)}>
            ...
            <button className="search-btn search-btn-mobile btn svenska focus 
                focus-invisible-input regular-font-size" type="submit">Sök</button>
            {numberOfResults ? <p id="number-of-results" className="number-of-results 
                regular-font-size" role="alert">{numberOfResults + ' träffar'}</p> : null}
...
export default SearchFormSwedish;