...
class ResultsGerman extends React.Component {
    constructor(props) {
        ...
        this.renderResultsLowContrast    = this.renderResultsLowContrast.bind(this);
        this.renderResultsSmallFontSize  = this.renderResultsSmallFontSize.bind(this);
        this.renderResultsInvisibleFocus = this.renderResultsInvisibleFocus.bind(this);
