...
class StaticLowFocusSwedish extends React.Component {
    constructor(props) {
        super(props);
            ...
            <section id="contact">
                ...
                <form ref={this.form}>
                    ...
                    <div className="row">
                        ...
                        <div className="form-right">
                            ...
                            <input id="phone" className="text focus-invisible-input text-input 
                                ...
                                aria-required="false" onChange={this.handlePhoneChange}>
                            </input>
                        </div>
                    </div>
                    {/* Meddelande */}
                    <label htmlFor="message" className="text h3-font-size">Meddelande *</label>
                    <textarea id="message" className="text focus-invisible-input regular-font-size" name="message"
                    ...
                    <label id="consent-label" htmlFor="consent" className="text regular-font-size line-height">
                        ...
                        <a className="text focus-invisible regular-font-size line-height" href=""> integritetspolicy</a> 
                    ...
                    <div className="row">
                        <button type="reset" className="reset-btn text focus-invisible">
                            Rensa</button>
                        <button type="submit" className="submit-btn text focus-invisible" 
...
export default StaticLowFocusSwedish;