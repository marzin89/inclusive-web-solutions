...
class StaticLowFocusGerman extends React.Component {
    constructor(props) {
        super(props);
            ...
            <section id="contact">
                ...
                <h2 style={this.state.error ? {display: 'block'} : {display: 'none'}} 
                    ...
                    Das Formular enthält {this.state.errorCountFirstName + this.state.errorCountLastName
                        ...
                        this.state.errorCountMessage + this.state.errorCountConsent} Fehler</h2>
                <form ref={this.form}>
                    <div className="row" onBlur={this.validateFirstName}>
                        {/* Förnamn */}
                        <div className="form-left">
                            <label htmlFor="first-name" className="text h3-font-size">Vorname *</label>
                            <input id="first-name" className="text focus-invisible-input text-input 
                                text-input-main regular-font-size" name="first_name" type="text" aria-required="true" 
                            ...
                            <p id="first-name-empty" className="text regular-font-size error empty" role="alert" 
                        ...
                        <div className="form-right" onBlur={this.validateLastName}>
                            ...
                            <input id="last-name" className="text focus-invisible-input text-input 
                                text-input-main regular-font-size" name="last_name" type="text" aria-required="true" 
                            ...
                            <p id="last-name-empty" className="text regular-font-size error empty" role="alert" 
                    ...
                    <div className="row">
                        ...
                        <div className="form-left" onBlur={this.validateEmail}>
                            ...
                            <input id="email" className="text focus-invisible-input text-input 
                                text-input-main regular-font-size" name="email" type="email" aria-required="true"
                            ...
                            <p id="email-empty" className="text regular-font-size error empty" role="alert" 
                            ...
                            <p id="email-invalid" className="text regular-font-size error" role="alert" 
                        ...
                        <div className="form-right">
                            ...
                            <input id="phone" className="text focus-invisible-input text-input 
                                text-input-main regular-font-size" name="phone" type="tel" aria-required="false" 
                                onChange={this.handlePhoneChange}></input>
                        </div>
                    </div>
                    {/* Meddelande */}
                    <label htmlFor="message" className="text h3-font-size">Mitteilung *</label>
                    <textarea id="message" className="text focus-invisible-input regular-font-size" 
                    ...
                    <p id="message-empty" className="text regular-font-size error" role="alert" 
                    ...
                    <input id="consent" className="focus-invisible-input" type="checkbox" aria-required="true" 
                    ...
                    <label id="consent-label" htmlFor="consent" className="text regular-font-size line-height">
                        ...
                        <a className="text focus-invisible regular-font-size line-height" href=""> Datenschutzerklärung</a> zu. 
                        <b className="text regular-font-size"></b></label>
                    {/* Här skrivs ett felmeddelande om användaren inte har samtyckt */}
                    <p id="consent-empty" className="text regular-font-size error" role="alert" 
                        style={this.state.consentEmpty ? {display: 'block'} : {display: 'none'}}>
                        {this.state.consentEmpty}</p>
                    <div className="row">
                        <button type="reset" className="reset-btn text focus-invisible">
                            Alle Felder löschen</button>
                        <button type="submit" className="submit-btn text focus-invisible" onClick={this.handleSubmit}>
                            Senden</button>
