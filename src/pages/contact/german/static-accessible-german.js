...
class StaticAccessibleGerman extends React.Component {
    constructor(props) {
        super(props);
            ...
            <section id="contact">
                ...
                <form ref={this.form}>
                    ...
                    <label id="consent-label" htmlFor="consent" className="text regular-font-size line-height">
                        ...
                        <a className="text focus regular-font-size line-height" href=""> Datenschutzerklärung</a> zu. 
...
export default StaticAccessibleGerman;